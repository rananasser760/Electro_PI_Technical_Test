...
async def entrypoint(ctx: JobContext) -> None:
    ...
    session = AgentSession(
        ...
        # LLM: OpenRouter's OpenAI-compatible endpoint (free-tier model).
        # This is the ONLY block that changed vs. agent.py (Groq version) --
        # everything else (persona, tools, STT, TTS) is untouched.
        llm=openai.LLM(
